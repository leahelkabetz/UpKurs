...
const NotFound = () => (
  <div className="NotFound" style={{ textAlign: 'center', paddingTop: '80px' }}>
    <div className="text">
      <h1 style={{ fontSize: '5rem', color: '#0288d1' }}>404</h1>
      <h2 style={{ fontSize: '2rem', marginBottom: '1rem' }}>לא נמצא :(</h2>
      <h3 style={{ fontSize: '1.2rem' }}>
        העמוד שחיפשת לא קיים – <a href="/" style={{ color: '#0288d1', textDecoration: 'underline' }}>חזרה לדף הבית</a>
      </h3>
    </div>
  </div>
);
